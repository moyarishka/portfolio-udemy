...
const BasePage = props => {
  ...
  const {
    ...
    className = '',
    header,
    title = 'Portfolio - Maryna',
    metaDescription='My name is Maryna and I am a software engineer. Throughout my career, I have acquired advanced technical knowledge and the ability to explain programming topics clearly and in detail to a broad audience.',
    canonicalPath,
    children } = props
